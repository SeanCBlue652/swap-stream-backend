...
for each in my_dict[f'GOAT TIER ANIME OPENINGS, by {user_name}:{user_id}']:
    print(each) # this dictionary contains the playlist copies with the name of the playlist as the key
